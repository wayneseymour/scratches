...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe.only('dashboard in space', () => {
    describe('Storing search sessions in space', () => {
      before(async () => {
        await load(['minimal_read', 'store_search_session']);
      });
  ...
  async function load(featureDiscover: string[]) {
